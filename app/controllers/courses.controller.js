const Data = require("../models/courses.model.js");
...
typeId:req.body.typeId,time_start:req.body.time_start,time_end:req.body.time_end,status:req.body.status,created_by:req.body.created_by,});
