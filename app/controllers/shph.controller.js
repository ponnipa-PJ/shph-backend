...
const datas = new Data({
    width:req.body.width,height:req.body.height,defaultshow:req.body.defaultshow,fullname:req.body.fullname,img_path:req.body.img_path,name:req.body.name,status:req.body.status,createdBy:req.body.createdBy});
