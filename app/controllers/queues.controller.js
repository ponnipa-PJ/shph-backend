const Data = require("../models/queues.model.js");
...
typeId:req.body.typeId,userId:req.body.userId,date:req.body.date,dentistcourseId:req.body.dentistcourseId,dentistId:req.body.dentistId,status:req.body.status,});
