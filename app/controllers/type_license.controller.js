const Data = require("../models/type_license.model.js");
...
name:req.body.name,status:req.body.status,created_by:req.body.created_by,});
...
exports.deletetype_license = (req, res) => {
    if (!req.body) {
    res.status(400).send({
    message: 'Content can not be empty!'
    });
