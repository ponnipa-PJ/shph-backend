...
this.mapeventId=datas.mapeventId;this.typeappointmentId=datas.typeappointmentId;this.locationId=datas.locationId;this.date=datas.date;this.time=datas.time;};
